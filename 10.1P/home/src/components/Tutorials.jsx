  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <div style={{ marginTop: '5%' }}>
        <Typography
          variant="h4"
          style={{ textAlign: "center", margin: "20px", color: '' }}
        >
          Featured Tutorials
        </Typography>
        <Divider style={{ margin: "10px 0", backgroundColor: '' }} />
              ...
              <Card sx={{ margin: "70px" }}>
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Divider style={{ margin: "10px 0", backgroundColor: '' }} />
                    <Typography fontWeight={600} variant="body2" color="text.secondary" sx={{ color: '' }}>
                      {article.author}
                    </Typography>
                  </CardContent>
                </CardActionArea>
